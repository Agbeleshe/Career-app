        ...
        <div className="flex flex-col w-full">
          ...
          >
            <div className="flex md:justify-center mb-2 md:mb-0 md:mr-2 w-auto">
              ...
              {suggestions.length > 0 && (
                <ul className="suggestions md:mr-24 justify-start md:mt-14 h-auto max-h-40 flex flex-row overflow-auto absolute p-2 shadow menu dropdown-content z-[1] bg-base-100 w-52 md:w-[500px]">
          ...
          <div className="h-full grid grid-rows md:grid-cols-2 mt-10 mb-10 md:mt-20 gap-20">
            {filteredResults.length === 0 ? (
              <h2 className="font-extrabold text-purple-500 mb-5 justify-center">
